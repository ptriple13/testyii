<?php
	...
	function abbreDate3($date) { // ชนิดข้อมูล 0000-00-00 00:00:00
	...
	function abbreDate4($date) { // ชนิดข้อมูล 0000-00-00 00:00:00
										//คืนค่าตัวอย่าง "27 ก.พ. 52 17:50:00"
		$tmp = explode(" ",$date);
		list($yy, $mm, $dd) = split('[/.-]',$tmp[0]);
	...
	function abbreDate5($date) { // ชนิดข้อมูล 0000-00-00 00:00:00
										//คืนค่าตัวอย่าง "27 ก.พ. 52 17:50:00"
		$tmp = explode(" ",$date);
		list($yy, $mm, $dd) = split('[/.-]',$tmp[0]);
	...
	function abbreDate6($date) { // ชนิดข้อมูล 0000-00-00 00:00:00
										//คืนค่าตัวอย่าง "27 ก.พ. 52 17:50:00"
		$tmp = explode(" ",$date);
		list($yy, $mm, $dd) = split('[/.-]',$tmp[0]);
